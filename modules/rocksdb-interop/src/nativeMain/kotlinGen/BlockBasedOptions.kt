...
class BlockBasedOptions(
  private val blockBasedOptions: CPointer<rocksdb_block_based_table_options_t> = rocksdb_block_based_options_create() 
     ?: error("could not instantiate new BlockBasedOptions")
