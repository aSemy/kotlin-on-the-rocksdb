...
class TransactionDbOptions(
  private val transactionDbOptions: CPointer<rocksdb_transactiondb_options_t> = rocksdb_transactiondb_options_create() 
     ?: error("could not instantiate new TransactionDbOptions")
